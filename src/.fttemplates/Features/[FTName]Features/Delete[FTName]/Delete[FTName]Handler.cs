...
{
    public sealed class Delete[FTName]Handler : IRequestHandler<Delete[FTName]Request, Get[FTName]Response>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly I[FTName]Repository _[FTName | camelcase]Repository;
        private readonly IMapper _mapper;

        public Delete[FTName]Handler(IUnitOfWork unitOfWork, I[FTName]Repository [FTName | camelcase]Repository, IMapper mapper)
        {
        ...
        public async Task<Get[FTName]Response> Handle(Delete[FTName]Request request, CancellationToken cancellationToken)
        {
            // Get existing [FTName | camelcase]
            ...
            // Update [FTName | camelcase] to be deleted
            _[FTName | camelcase]Repository.Delete([FTName | camelcase], request.DeletedById, cancellationToken);
            await _unitOfWork.SaveAsync(cancellationToken);

            // Map the deleted [FTName | camelcase] to the response
